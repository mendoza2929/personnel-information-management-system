...
<html lang="en">
   ...
   ?>
      ...
      <main id="main" class="main">
               ...
               <ol class="breadcrumb">
                 ...
                 <div class="card border-0 shadow-sm mb-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="card-title m-0 fw-bold"><i class="bi bi-chat-square-heart"></i> Unit</h5>
        ...
        <div class="modal fade" id="edit_unit" data-bs-backdrop="static" data-bs-keyboard= "true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form id="edit_unit_form">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="modal-title"><i class="bi bi-clipboard-data"></i> Edit Unit</div>
                        </div>
                        <div class="modal-body"> 
                            <div class="mb-3">
                                <label class="form-label fw-bold">Unit</label>
